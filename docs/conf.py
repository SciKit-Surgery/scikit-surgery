...
# -*- coding: utf-8 -*-
#
# scikit-surgery documentation build configuration file, created by
...
# This allows modules to be indexed under the submodule name rather than all appearing under sksurgery
modindex_common_prefix = [
    'sksurgery.'
]

# General information about the project.
project = u'scikit-surgery'
...
# The short X.Y version.
# version = sksurgery.__version__
# The full version, including alpha/beta/rc tags.
# release = sksurgery.__version__
...
htmlhelp_basename = 'scikit-surgerydoc'
...
latex_documents = [
    ('index', 'scikit-surgery.tex',
     u'scikit-surgery Documentation',
     u'Thomas Dowrick', 'manual'),
]
